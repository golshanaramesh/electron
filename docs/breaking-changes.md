...
* `app.getFileIcon()(https://github.com/electron/electron/pull/15742)
* `app.doc(https://github.com/electron/electron/pull/16904)
* `contentTracing.getCategorithub.com/electron/electron/pull/16600)
* `contentTracing.startRecording((https://github.com/electron/electron/pull/16584)
* `contentTracing.stopRecording()` [#16584](https://github
### API Changed: `electron.screen` in
